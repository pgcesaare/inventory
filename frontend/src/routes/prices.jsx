  ...
  return (
    <div className="w-full min-h-screen bg-background p-4 md:p-6">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4">
        <div className="rounded-2xl border border-primary-border/40 bg-white p-4 shadow-sm md:p-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="text-xs font-semibold uppercase tracking-wide text-secondary">Catalogs</p>
            ...
            <div className="rounded-xl border border-primary-border/45 bg-primary-border/10 px-3 py-2 text-right">
        ...
        {loadingRanches ? (
          <div className="rounded-2xl border border-primary-border/40 bg-white p-4 text-sm text-secondary shadow-sm">
            Loading states...
          </div>
          ...
          <div className="flex flex-col gap-3">
            {filteredStates.map((stateItem) => {
              ...
              return (
                <div
                  key={stateItem.key}
                  className={`overflow-visible rounded-2xl border bg-white shadow-sm transition ${
                    isOpen
                      ? "border-action-blue/45"
                      : "border-primary-border/45"
                  }`}
                >
                  <button
                    type="button"
                    className={`flex w-full items-center justify-between gap-3 px-4 py-3 text-left transition ${
                      isOpen ? "bg-action-blue/5" : "hover:bg-primary-border/10"
                    }`}
                    onClick={() => toggleStatePanel(stateItem.key)}
                  >
                    <div className="min-w-0">
                      <p className="text-base font-semibold text-primary-text">{stateItem.label}</p>
                    ...
                    <ChevronDown className={`size-4 shrink-0 text-secondary transition-transform ${isOpen ? "rotate-180" : ""}`} />
                  </button>

                  {isOpen && (
                    <div className="border-t border-primary-border/30 px-4 py-4 md:px-5">
                      {config.loading ? (
                        <p className="text-sm text-secondary">Loading prices...</p>
                      ) : (
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="rounded-xl border border-primary-border/50 bg-primary-border/5 p-3">
                          ...
                          {activePeriod ? (
                            <div className="rounded-xl border border-primary-border/55 bg-primary-border/5 p-4">
                              ...
                              <div className="mt-4 rounded-xl border border-primary-border/55 bg-white p-3">
                              ...
                              <div className="mt-4 flex flex-wrap items-center justify-between gap-2">
                                ...
                                >
                                  ...
                                  {config.saving ? "Saving..." : "Save State Prices"}
                                </button>
                              </div>
                            </div>
                          ) : (
